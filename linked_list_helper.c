...
/**
 * add_alias_end -Appends a new node to the tail of the linked list
 * @head: A pointer to the head of the list_t list.
 * @name: The name of the new alias to be added.
 * @value: The value of the new alias to be added.
 *
 * Return: In case of an error, it returns NULL. Otherwise,
 ...
 * releasing all its nodes
 * @head: THe head node of the alias_t list
 */
void free_alias_list(alias_t *head)
{
	alias_t *next;
 ...
 * freeing all its nodes
 * @head: The head node of the list_t list
 */
void free_list(list_t *head)
{
	list_t *next;
